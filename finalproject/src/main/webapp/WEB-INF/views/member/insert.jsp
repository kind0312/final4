...
<body>
	...
	<div class="container-fluid">
				...
				<div class="row form-group">
					...
					<div class="input-group">
						<input type="text" name="memberId" class="form-control underline w-75" aria-describedby="memberId-button">
	      				<button class="btn btn-outline-primary rounded w-25" type="button" id="memberId-button">중복 확인</button>
					</div>
			...
			<div class="col-lg-4 offset-lg-4 col-md-6 offset-md-3 col-sm-8 offset-sm-2">
				<div class="row">
					<label>
						휴대폰
						<i class="fa-solid fa-asterisk text-primary"></i>
					<input type="tel" name="memberTel" class="form-control underline" maxlength="11">
					</label>
				</div>
			</div>
		</div>
			...
			<div class="col-lg-4 offset-lg-4 col-md-6 offset-md-3 col-sm-8 offset-sm-2">
				<div class="row">
					<label>
						주소
						<i class="fa-solid fa-asterisk text-primary"></i>
					<input type="text" name="memberPost" class="form-control underline" maxlength="6">
					</label>
				</div>
			</div>
		</div>
		...
		<div class="row mt-4 text-center">
			<div class="col-lg-4 offset-lg-4 col-md-6 offset-md-3 col-sm-8 offset-sm-2">
				<button type="submit" class="btn btn-primary rounded w-75">회원가입</button>
			</div>
		</div>
    </div>
